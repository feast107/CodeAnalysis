...
{
    [Literal("Feast.CodeAnalysis.Scripting.Generates.ArrayBuilder")]
    ...
    internal sealed partial class ArrayBuilder<T> : IReadOnlyCollection<T>, IReadOnlyList<T>, ICollection<T>, IPooled
    {
        ...
        public ImmutableArray<TResult> SelectAsArray<TResult>(Func<T, TResult> map)
        {
            ...
            {
                case 0:
                    return new ImmutableArray<TResult> { };

                case 1:
                    return new ImmutableArray<TResult> { map(this[0]) };

                case 2:
                    return new ImmutableArray<TResult> { map(this[0]), map(this[1]) };

                case 3:
                    return new ImmutableArray<TResult> { map(this[0]), map(this[1]), map(this[2]) };

                case 4:
                    return new ImmutableArray<TResult> { map(this[0]), map(this[1]), map(this[2]), map(this[3]) };
        ...
        public ImmutableArray<TResult> SelectAsArray<TArg, TResult>(Func<T, TArg, TResult> map, TArg arg)
        {
            switch (Count)
            {
                ...
                case 1:
                    return new ImmutableArray<TResult> { map(this[0], arg) };

                case 2:
                    return new ImmutableArray<TResult> { map(this[0], arg), map(this[1], arg) };

                case 3:
                    return new ImmutableArray<TResult> { map(this[0], arg), map(this[1], arg), map(this[2], arg) };

                case 4:
                    return new ImmutableArray<TResult>
                        { map(this[0], arg), map(this[1], arg), map(this[2], arg), map(this[3], arg) };
        ...
        public ImmutableArray<TResult> SelectAsArrayWithIndex<TArg, TResult>(Func<T, int, TArg, TResult> map, TArg arg)
        {
            switch (Count)
            {
                ...
                case 1:
                    return new ImmutableArray<TResult> { map(this[0], 0, arg) };

                case 2:
                    return new ImmutableArray<TResult> { map(this[0], 0, arg), map(this[1], 1, arg) };

                case 3:
                    return new ImmutableArray<TResult>
                        { map(this[0], 0, arg), map(this[1], 1, arg), map(this[2], 2, arg) };

                case 4:
                    return new ImmutableArray<TResult>
                        { map(this[0], 0, arg), map(this[1], 1, arg), map(this[2], 2, arg), map(this[3], 3, arg) };
