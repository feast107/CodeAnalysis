...
namespace Feast.CodeAnalysis.SourceGenerators.Templates
{
    ...
    internal ref struct ImmutableArrayBuilder<T>
    {
        ...
        /// <inheritdoc cref="ImmutableArrayBuilder{T}.Builder.Count"/>
        ...
        /// <inheritdoc cref="ImmutableArrayBuilder{T}.Builder.Add(T)"/>
        ...
        /// <inheritdoc cref="ImmutableArrayBuilder{T}.Builder.ToArray"/>
	    ...
	    internal const string ImmutableArrayBuilderText =
            """
